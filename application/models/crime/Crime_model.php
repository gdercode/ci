...
//-----------------------------------------------------------------------------------------------------------------------------------
	...
	public function insert_course( $module_id, $module_name, $module_credit)
	{
		return $this->db->set( array(
										'module_id' => $module_id,
...
//-----------------------------------------------------------------------------------------------------------------------------------
	...
	public function update_course($course_id,$course_name,$course_credit)
	{
		return $this->db->set( array(
										'module_name'=>$course_name,
										'module_credit'=>$course_credit
									) 
							 )
						->where('module_id',$course_id)
						->update($this->course_table);
	}
...
//-----------------------------------------------------------------------------------------------------------------------------------
	...
	{
		return $this->db->where('module_id',$course_id)->delete($this->course_table);
	}
